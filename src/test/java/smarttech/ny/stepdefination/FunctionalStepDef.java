package smarttech.ny.stepdefination;
...
public class FunctionalStepDef extends ParentClass {
	...
	public void verify_that_home_page_is_visible_successfully() {
		...
		/*pf.getEnterEmail().sendKeys("tanvirpatwary16@gmail.com");
		pf.getPassword().sendKeys("Tester01");
		pf.getClinckOnLoninBTN().click();*/
        ...
        String expected = "Home";//BA requirement
